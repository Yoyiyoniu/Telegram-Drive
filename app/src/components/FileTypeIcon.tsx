...
const extensionMap: Record<string, { icon: typeof File; color: string }> = {
	...
	// 3D Models
	stl: { icon: FileType, color: "text-cyan-400" },
	"3mf": { icon: FileType, color: "text-cyan-400" },
	obj: { icon: FileType, color: "text-cyan-400" },
	gltf: { icon: FileType, color: "text-cyan-400" },
	glb: { icon: FileType, color: "text-cyan-400" },
	fbx: { icon: FileType, color: "text-cyan-400" },
	dae: { icon: FileType, color: "text-cyan-400" },
	ply: { icon: FileType, color: "text-cyan-400" },
};
...
export function FileTypeIcon({
	...
	return (
		<Icon className={`${sizeClass} ${color} pointer-events-none select-none`} />
	);
}
