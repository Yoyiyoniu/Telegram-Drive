...
export function ExternalDropBlocker({
	...
	return (
		<div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center pointer-events-none">
			<div className="glass-card rounded-2xl p-8 max-w-md mx-4 shadow-2xl pointer-events-auto">
				<div className="flex flex-col items-center text-center gap-4">
					...
					<div>
						...
						<p className="text-telegram-subtext text-sm">
							To upload files, please use the <strong>Upload</strong> button in
							the toolbar.
							<br />
