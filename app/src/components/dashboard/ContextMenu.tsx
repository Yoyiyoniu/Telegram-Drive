...
export function ContextMenu({
	...
	return (
		<div
			ref={menuRef}
			className="fixed z-50 min-w-[200px] glass-card backdrop-blur-xl shadow-2xl p-1.5 animate-in fade-in zoom-in-95 duration-100 flex flex-col gap-0.5 rounded-xl"
